...
const HeaderDesktop = ({SetDark}) => {
  return (
    <div>
      {/* Header Nav  */}
      <div className="hidden md:block fixed top-9 right-0 left-0 w-[90%] h-24 rounded-3xl bg-black/50 mx-auto backdrop-blur-md py-5 xl:px-10 lg:px-5 md:px-3 z-20">
        <div className="w-full flex justify-between items-center font-Dana-Regular">
          {/* Logo & Menu */}
          <div className="flex items-center md:gap-x-3 lg:gap-x-5 xl:gap-x-9 h-14 ">
            {/* logo */}
            <img src="./img/app-logo.png" alt="" className="max-lg:w-12" />
            {/* Menu */}
            <ul className="text-gray-300 flex md:gap-x-2 lg:gap-x-9 *:hover:text-orange-200 transition-colors h-full *:leading-14 ">
              <li>
          ...
          {/* Buttons */}
          <div className="flex items-center md:gap-x-4 lg:gap-x-6 xl:gap-x-10 text-orange-200">
            {/* Buttons */}
            <div className="flex items-center md:gap-x-2 lg:gap-x-4 xl:gap-x-6 ">
              {/* Shopping Button */}
              <div className="relative h-14 flex justify-center items-center group ">
                <svg className="md:size-6 lg:size-8 cursor-pointer">
              ...
              <button onClick={()=>{SetDark(prev=>!prev)}}>
                <svg className="md:size-6 lg:size-8 dark:hidden cursor-pointer">
                  <use href="./sprite.svg#moon" />
                </svg>
                <svg className="md:size-6 lg:size-8 hidden dark:block cursor-pointer">
            ...
            <Link
              to="#"
              className="flex items-center gap-x-2.5 hover:rounded-[100px] hover:bg-orange-200/10 xl:py-2.5 xl:px-6 lg:px-3 lg:py-1.25 md:px-2 md:py-1.5"
            >
              <svg className="md:size-6 lg:size-8">
